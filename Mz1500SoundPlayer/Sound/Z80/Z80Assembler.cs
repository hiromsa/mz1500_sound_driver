...
public class Z80Assembler
{
    ...
    {
        // é¬E½»éƒ¢âˆšâEè´E¿ç¹§ä¸Šï½Œç¹§æŠ€80èœ»E½è‰ï½¤ç¸ºE®ç¹èEãE¹äº¥ãƒ»è³å¤‚ï½¾E© (VBè¿šåŒ»Â°ç¹§è‡¥E§E»è®€ãƒ»
...
_mnemonicMap.Add(new Z80Part[]{ OpCodeLD, SP, LabelRef(new AsmLabel("")) }, new byte[]{ 0x31 });
    }
    ...
    public void DW(Z80Part part)
    {
        ...
        {
            _dataList.Add(new DataLabelRef(r.Label)); // LabelRefç¸ºE¯2ç¹èEãE¹åŒ»ãE¹§Eµç¹§E¤ç¹ï½³ç¸ºå¶E‹ç¹§åŒ»â‰§ç¸ºE«Pass 1ç¸ºE§èœE½¦é€EEEE¹§å¾Œâ€»ç¸ºãƒ»EE
        }
